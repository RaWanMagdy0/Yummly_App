...
import 'package:yummly_app/auth/data/models/request_model/Sign_in_request_model.dart';
          ...
          case SignInFail():
            {
              ScaffoldMessenger.of(context).showSnackBar(
                SnackBar(
                  content: Text(state.errorMassage ?? "Failed to sign in"),
          ...
          case SignInSuccess():
            {
              ...
              // AppDialogs.showSuccessDialog(context: context, message: local.userLoggedInSuccessfully,
              //  whenAnimationFinished: () {Navigator.pushReplacementNamed(context, PageRouteName.homeLayout);},);
            }
          default:
            {}
        }
